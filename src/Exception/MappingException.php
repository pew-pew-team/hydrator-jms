...
{
    final public const int ERROR_CODE_VALUE_NOT_PASSED = 0x01;

    final public const int ERROR_CODE_VALUE_INVALID = 0x02;

    final public const int ERROR_CODE_VALUE_OF_FIELD_NOT_PASSED = 0x03;

    final public const int ERROR_CODE_VALUE_OF_FIELD_INVALID = 0x04;

    protected const int ERROR_CODE_LAST = self::ERROR_CODE_VALUE_OF_FIELD_INVALID;
